...
const heroImages = [
  ...
  "https://images.unsplash.com/photo-1759662011366-8a743eae9649?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
...
export default function HeroSection() {
  ...
  return (
    <section className="relative isolate min-h-[100vh] flex items-center justify-center overflow-hidden text-white pt-20 md:pt-0">
      ...
      <div className="relative mx-auto flex min-h-[92vh] w-[94vw] max-w-330 flex-col justify-center px-3 pb-10 pt-8 sm:px-4 md:justify-end md:pb-14 md:pt-8">
        <div className="w-full text-center md:mt-auto md:text-left">
           <h1 className="mx-auto max-w-[18ch] text-4xl font-medium leading-[1.06] sm:text-5xl md:mx-0 md:text-6xl lg:text-7xl">
          ...
          <div className="mt-8 border-t border-white/35 pt-5 md:mt-12 md:pt-7">
            <div className="grid gap-5 text-[1.08rem] leading-relaxed text-white/90 md:grid-cols-[1fr_1fr_auto] md:items-start md:gap-10">
              <p className="mx-auto max-w-[34ch] md:mx-0">
              ...
              <p className="mx-auto max-w-[36ch] md:mx-0">
