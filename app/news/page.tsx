...
export default function NewsPage() {
    const imageSet = {
      hero: "https://images.unsplash.com/photo-1465101046530-73398c7fda0c?auto=format&fit=crop&w=1400&q=80",
    };
  return (
    <>
            ...
            <div className="mt-8 border-t border-white/35 pt-5 md:mt-12 md:pt-7">
              <div className="grid gap-5 text-[1.08rem] leading-relaxed text-white/90 md:grid-cols-[1fr_1fr_auto] md:items-start md:gap-10">
                <p className="max-w-[34ch]">
                  Stay up to date with the latest news, updates, and announcements from our company. Explore our achievements, events, and industry insights.
                </p>
